...
# trackers.extend(trackerlist('dimp', 'dimp50', None, range(0,5), 'DiMP50'))        'DIFFUSIONTRACK_ep0100.pth.tar',
...
trackers.extend(trackerlist(name='supersbt', parameter_name='supersbt_256_000', dataset_name=dataset_name,
                            run_ids=None, display_name='supersbt_256_000'))

trackers.extend(trackerlist(name='supersbt', parameter_name='supersbt_256_2temp_000', dataset_name=dataset_name,
                            run_ids=None, display_name='supersbt_256_2temp_000'))
trackers.extend(trackerlist(name='supersbt', parameter_name='supersbt_256_small_000', dataset_name=dataset_name,
                            run_ids=None, display_name='supersbt_256_small_000'))
trackers.extend(trackerlist(name='supersbt', parameter_name='supersbt_256_light_000', dataset_name=dataset_name,
                            run_ids=None, display_name='supersbt_256_light_000'))
#trackers.extend(trackerlist(name='ostrack', parameter_name='hvitb_256_got_001', dataset_name=dataset_name,
                 #           run_ids=None, display_name='hvitb_256_got_001'))
